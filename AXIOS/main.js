...
function addTodo() {
  ...
  axios.post("https://jsonplaceholder.typicode.com/todos",{data:"Anusha",completed:false})
  .then(res=>showOutput(res))
  .catch(err=> console.log(err))
}
...
// PUT/PATCH REQUEST
function updateTodo() {
  axios.put("https://jsonplaceholder.typicode.com/todos/4",{title:"Anusha",completed:true})
  .then(res=>showOutput(res))
  .catch(err=> console.log(err))
...
function errorHandling() {
  axios.get("https://jsonplaceholder.typicode.com/todoss",{params: {_limit:5}})
      ...
      .catch(err=>
        ...
        else if(err.request)// request made no response
        {
